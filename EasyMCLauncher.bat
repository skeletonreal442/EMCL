...
if "%CHOICE%"=="1" goto OPEN_VERSIONS
...
cls
start "" "%VERSIONS_DIR%"
echo [+] Папка открыта: %VERSIONS_DIR%
echo E. Назад в главное меню
:WAIT_OPEN
set /p "BACK_CHOICE=Введите 'e' для возврата в меню: "
if /i "%BACK_CHOICE%"=="e" goto MAIN_MENU
goto WAIT_OPEN
